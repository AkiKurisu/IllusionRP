...
namespace Illusion.Rendering.PostProcessing
{
    public class AdvancedTonemappingPass : ScriptableRenderPass
    {
        ...
        {
            using (var builder = renderGraph.AddUnsafePass<AdvancedTonemappingPassData>("Advanced Tonemapping", out var passData, profilingSampler))
            {
                ...
                builder.SetRenderFunc(static (AdvancedTonemappingPassData data, UnsafeGraphContext context) =>
                {
