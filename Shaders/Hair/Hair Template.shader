	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Receive Shadows:Force Off,Force On,Material Toggle:Material Toggle
				...
				Force On:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _RECEIVE_SHADOWS_OFF
				...
				Force Off:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _RECEIVE_SHADOWS_OFF
				...
				Material Toggle:SetDefine:OITTransparent:pragma shader_feature_local_fragment _RECEIVE_SHADOWS_OFF
			...
			Option:Specular Highlights:Force Off,Force On,Material Toggle:Material Toggle
				...
				Force On:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _SPECULARHIGHLIGHTS_OFF
				...
				Force Off:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _SPECULARHIGHLIGHTS_OFF
				...
				Material Toggle:SetDefine:OITTransparent:pragma shader_feature_local_fragment _SPECULARHIGHLIGHTS_OFF
			...
			Option:Environment Reflections:Force Off,Force On,Material Toggle:Material Toggle
				...
				Force On:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _ENVIRONMENTREFLECTIONS_OFF
				...
				Force Off:RemoveDefine:OITTransparent:pragma shader_feature_local_fragment _ENVIRONMENTREFLECTIONS_OFF
				...
				Material Toggle:SetDefine:OITTransparent:pragma shader_feature_local_fragment _ENVIRONMENTREFLECTIONS_OFF
			...
			Option:GPU Instancing:false,true:true
				...
				true:SetDefine:OITTransparent:pragma multi_compile_instancing
				...
				false:RemoveDefine:OITTransparent:pragma multi_compile_instancing
				...
				true:SetDefine:OITTransparent:pragma instancing_options renderinglayer
				...
				false:RemoveDefine:OITTransparent:pragma instancing_options renderinglayer
			Option:LOD CrossFade:false,true:true
				true:SetDefine:Forward:pragma multi_compile _ LOD_FADE_CROSSFADE
				true:SetDefine:OITTransparent:pragma multi_compile _ LOD_FADE_CROSSFADE
				...
				true:SetDefine:PostDepthOnly:pragma multi_compile _ LOD_FADE_CROSSFADE
				...
				false:RemoveDefine:OITTransparent:pragma multi_compile _ LOD_FADE_CROSSFADE
				...
				false:RemoveDefine:PostDepthOnly:pragma multi_compile _ LOD_FADE_CROSSFADE
		...
		*/
		...
		Pass
		{
						...
						/*ase_frag_input*/ ) : SV_Target
			{
				...
				float3 Tangent = /*ase_frag_out:Tangent;Float3;21;-1;_TangentWS*/float3(0, 0, 1)/*end*/;
