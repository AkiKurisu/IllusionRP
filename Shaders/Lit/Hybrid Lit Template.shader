	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:  Instanced Terrain Normals,InvertActionOnDeselection:Force Vertex,Force Pixel,Material Option:Force Pixel
				...
				Material Option?Category=Terrain:SetDefine:ForwardGBuffer:pragma shader_feature _INSTANCEDTERRAINNORMALS_PIXEL
				...
				disable:RemoveDefine:ForwardGBuffer:pragma shader_feature _INSTANCEDTERRAINNORMALS_PIXEL
